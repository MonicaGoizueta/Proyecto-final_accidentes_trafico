...
2) Limpieza / transfromación de la información: Hemos hecho una transformación de la información.
...
Análisis Exploratorio.ipynb : Contiene una exploración del DataFrame
Transformación_v1.ipynb : Contiene la limpieza de datos del excel incial de 2021_Accidentalidad
Selenium_meteo.ipynb : Contiene el escrapeo de una web de meteo y el mergeo con el DF principal limpio 
Visualización.ipynb : Gráficos del estudio
